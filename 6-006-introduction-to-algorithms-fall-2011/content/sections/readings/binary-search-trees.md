...
*   [bst.py (PY)](/coursemedia/6-006-introduction-to-algorithms-fall-2011/7f7ba1c1c85b1ec4bd58965bfe791489_bst.py)
    *   Features: insert, find, delete\_min, ASCII art
*   [bstsize.py (PY)](/coursemedia/6-006-introduction-to-algorithms-fall-2011/c73ee3242ff0adf838ad898c415fd267_bstsize.py)
    *   Imports and extends bst.py
    *   Augmentation to compute subtree sizes
*   [bstsize\_r.py (PY)](/coursemedia/6-006-introduction-to-algorithms-fall-2011/866988d04cb099a077e8e93f554c5b85_bstsize_r.py)
...
*   [avl.py (PY)](/coursemedia/6-006-introduction-to-algorithms-fall-2011/e1bf91495a4b705a5a7794d01029d802_avl.py)
    *   Imports and extends bst.py
    *   Features: insert, find, delete\_min, ASCII art
